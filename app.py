...
st.sidebar.title("Sentiment Analyisis of Tweets about US-Airlines")
...
if not st.sidebar.checkbox("Close", True, key="3"):
        ...
        workcloud = WordCloud(stopwords=STOPWORDS, background_color='white', height=640, width=800).generate(processed_words)
